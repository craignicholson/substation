...
```{r Daily Substation Voltage & Power Factor v2 }
...
ggplot(data=tsh[!is.na(tsh$pfmedian), ], 
    ...
    geom_errorbar(data=lagging_outliers_p, aes(ymin = vmin, ymax = vmax), width = 0.0025) + 
    ...
    geom_errorbarh(data=leading_outliers_p, aes(xmax = pfmax, xmin = pfmin, height = .4)) +
    geom_errorbarh(data=lagging_outliers_p, aes(xmax = pfmax, xmin = pfmin, height = .4)) +
